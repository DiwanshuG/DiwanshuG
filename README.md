...
* Learning Machine Learning (core + boosting algorithms)
* Building end-to-end ML systems (data → model → API → deployment)
* Exploring FastAPI and model deployment
* Improving data analysis and feature engineering
